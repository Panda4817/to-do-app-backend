...
public class TaskEntity {
    ...
    public TaskEntity(long id, String username, String title, String description, LocalDate dueDate, boolean isCompleted) {
        this.id = id;
    ...
    public TaskEntity(String username, String title, String description, LocalDate dueDate) {
        this.username = username;
        this.title = title;
        this.description = description;
        this.dueDate = dueDate;
